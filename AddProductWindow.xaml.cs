...
namespace _01electronics_inventory
{
    ...
    public partial class AddProductWindow : Window
    {
        ...
        public AddProductWindow(ref CommonQueries mCommonQueries, ref CommonFunctions mCommonFunctions, ref IntegrityChecks mIntegrityChecks, ref Employee mLoggedInUser, ref Product pProduct, ref int mViewAddCondition)
        {
