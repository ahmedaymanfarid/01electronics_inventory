...
namespace _01electronics_inventory
{
    ...
    public partial class MaintContractsPaymentAndDeliveryPage : Page
    {
        ...
        public MaintContractsPaymentAndDeliveryPage(ref CommonQueries mCommonQueries, ref CommonFunctions mCommonFunctions, ref IntegrityChecks mIntegrityChecks, ref Employee mLoggedInUser, ref MaintenanceContract mMaintOffer, int mViewAddCondition, ref MaintContractsAdditionalInfoPage mMaintOfferAdditionalInfoPage)
        {
