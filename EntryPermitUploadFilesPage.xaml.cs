...
{
    /// <summary>
    /// Interaction logic for EntryPermitUploadFilesPage.xaml
    /// </summary>
    public partial class EntryPermitUploadFilesPage : Page
    {
        ...
        AddEntryPermitItemPage addEntryPermitItem;
        AddEntryPermitPage addEntryPermitPage;
        AddEntryPermitWindow AddEntryPermitWindow;

        MaterialEntryPermit materialEntryPermit;

        public EntryPermitUploadFilesPage(ref CommonQueries mCommonQueries, ref CommonFunctions mCommonFunctions, ref IntegrityChecks mIntegrityChecks, ref Employee mLoggedInUser, AddEntryPermitItemPage mEntryPermitItemPage, AddEntryPermitPage mEntryPermitPage,AddEntryPermitWindow mWindow, ref MaterialEntryPermit mMaterialEntryPermit)
        {
            ...
            addEntryPermitItem = mEntryPermitItemPage;
            addEntryPermitPage = mEntryPermitPage;

            AddEntryPermitWindow = mWindow;

            ftpObject = new FTPServer();

            materialEntryPermit = mMaterialEntryPermit;
            ...
            serverFolderPath = BASIC_MACROS.ENTRY_PERMIT_FILES_PATH + materialEntryPermit.GetEntryPermitId() + "/";
