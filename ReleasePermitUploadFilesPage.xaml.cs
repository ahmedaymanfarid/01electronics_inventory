...
{
    /// <summary>
    /// Interaction logic for ReleasePermitUploadFilesPage.xaml
    /// </summary>
    public partial class ReleasePermitUploadFilesPage : Page
    {
        ...
        public AddReleasePermitItemPage addReleasePermitItemPage;
        public AddReleasePermitPage addReleasePermitPage;
        AddReleasePermitWindow addReleasePermitWindow;

        MaterialReleasePermits materialReleasePermit;

        public ReleasePermitUploadFilesPage(ref CommonQueries mCommonQueries, ref CommonFunctions mCommonFunctions, ref IntegrityChecks mIntegrityChecks, ref Employee mLoggedInUser,  AddReleasePermitItemPage mReleasePermitItemPage, AddReleasePermitPage mReleasePermitPage, AddReleasePermitWindow mWindow, ref MaterialReleasePermits mMaterialReleasePermit)
        {
            ...
            addReleasePermitItemPage = mReleasePermitItemPage;
            addReleasePermitPage = mReleasePermitPage;

            addReleasePermitWindow = mWindow;
            ...
            serverFolderPath = BASIC_MACROS.RELEASE_PERMIT_FILES_PATH + materialReleasePermit.GetReleaseId() + "/";
        ...
        private void BackButtonOnClick(object sender, RoutedEventArgs e)
        {
            ...
            NavigationService.Navigate(addReleasePermitItemPage);
