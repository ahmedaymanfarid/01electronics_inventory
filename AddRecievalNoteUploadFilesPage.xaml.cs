...
{
    /// <summary>
    /// Interaction logic for AddRecievalNoteUploadFilesPage.xaml
    /// </summary>
    public partial class AddRecievalNoteUploadFilesPage : Page
    {
        ...
        AddRecievalNoteItemPage recievalNotePage;

        RecievalNoteWindow parentWindow;

        MaterialRecievalNote materialRecievalNote;

        public AddRecievalNoteUploadFilesPage(ref CommonQueries mCommonQueries, ref CommonFunctions mCommonFunctions, ref IntegrityChecks mIntegrityChecks, ref Employee mLoggedInUser, AddRecievalNoteItemPage Mpage, ref MaterialRecievalNote mMaterialRecievalNote)
        {
            ...
            recievalNotePage = Mpage;

            parentWindow = recievalNotePage.parentWindow;
            

            ftpObject = new FTPServer();

            
            materialRecievalNote = mMaterialRecievalNote;
            ...
            serverFolderPath = BASIC_MACROS.RECIEVAL_NOTE_FILES_PATH + materialRecievalNote.GetRecievalNoteId() + "/";
        ...
        {
            if (recievalNotePage != null)
                NavigationService.Navigate(recievalNotePage);
