...
{
    /// <summary>
    /// Interaction logic for AddRentryUploadFilesPage.xaml
    /// </summary>
    public partial class AddRentryUploadFilesPage : Page
    {
        ...
        protected RentryPermit rentryPermit;
        ...
        AddRentryItemPage rentryPermitPage ;

        RentryPermitWindow parentWindow;

        public AddRentryUploadFilesPage(ref CommonQueries mCommonQueries, ref CommonFunctions mCommonFunctions, ref IntegrityChecks mIntegrityChecks, ref Employee mLoggedInUser, AddRentryItemPage Mpage, ref RentryPermit mRentryPermit)
        {
            ...
            rentryPermitPage = Mpage;

            parentWindow=rentryPermitPage.parentWindow;
  
            ftpObject = new FTPServer();

            rentryPermit = mRentryPermit;
            ...
            serverFolderPath = BASIC_MACROS.RE_ENTRY_FILES_PATH + rentryPermit.GetReEntryId() + "/";
        ...
        {
            if(rentryPermitPage!= null) 
            NavigationService.Navigate(rentryPermitPage);
        ...
        //{
        //    wordAutomation.AutomateWorkOrder(rentryPermit);
        //}
